...
I might eventually put some links here. But here's a teaser: my [next blog post](https://inariksit.github.io/gf/2019/02/17/beyond-API.html) will be about going beyond the API, and how to limit the dangers of using low-level opers in your application grammar.
