...
1. The trees have a non-linear, *nested* tree structure. (Intuition: they look more like 🌲 or 🌿! Multiple things can grow from them simultaneously.) <!-- Real plants like 🌲 or 🌿 can grow new leaves in multiple places simultaneously, and so do context-free grammars. -->
...
#### Inherent parameters, or “who is my subtree?”
