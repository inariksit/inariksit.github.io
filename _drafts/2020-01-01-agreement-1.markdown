...
Now let's add intransitive verbs. As you can see, a 3rd person singular object (*water*, *the cat*, …) is marked with an __-s__ in the verb. Logically, when a 3rd person singular NP is a subject of an intransitive verb, then the verb should also be marked with __-s__.

Similarly, the 1st person singular patient (*me*) is unmarked as an object, so *me* as a subject should also be unmarked. Yes, the subject case for an intransitive verb is now *me*---*I* is reserved for transitive verbs.
...
However, I have ignored NP case so far in my GF examples, and I continue ignoring it. (Apologies if you got excited about weird subject cases!) One thing at a time, and now we're looking at verbal agreement.
...
Because `V` needs a subject to know the correct form, `VP` needs to be an inflection table too. Just looking at `UseV` and `PredVP`, things seem exactly like in [ordinary English](#gf-grammar-for-english).
...
|**Sg3 object**   |I write-**∅** the blog | the blog write-**s** the blog   |
|-----------------|-----------------------|---------------------------------|
...
|**P3 object**    |you love-**∅** him  | he love-**s** him   |
|-----------------|--------------------|---------------------|


I think you've seen enough GF code that you should be able to do this on your own! Here is a complete abstract syntax, a small lexicon and the concrete syntaxes for English, LEBOM and LEBOM-ERG. Your task is to implement Like-English-but-alternate-marking. **TODO:link**
