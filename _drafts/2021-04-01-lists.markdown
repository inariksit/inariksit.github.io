...
The only documentatio of Coordination (that I'm aware of) is in the comments of the module itself, and it looks like [the following](https://github.com/GrammaticalFramework/gf-rgl/blob/master/src/prelude/Coordination.gf#L17-L22):
